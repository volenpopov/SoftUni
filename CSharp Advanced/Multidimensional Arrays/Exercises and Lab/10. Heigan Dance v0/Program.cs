    ...
    class Program
    {
        static void Main(string[] args)
        {
            ...
            while (true)
            {
                ...
                {
                    PrintOutput(player, Heigan, killingSpell, playerRow, playerColumn);
                }
                ...
                if (Heigan <= 0) { PrintOutput(player, Heigan, killingSpell, playerRow, playerColumn); }

                else if (PlayerIsWithinDamagedArea)
                {
        ...
        private static void PrintOutput(int player, double Heigan, string killingSpell, int playerRow, int playerColumn)
        {
